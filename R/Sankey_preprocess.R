...
names(joinDf) <- c("ID", "Type.Intake", "Sex.Intake", "Age.Intake", "Color.Intake", "Outcome","Type.Outcome","Sex.Outcome","Age.Outcome","Color.Outcome")
...
joinDf$Age.Outcome <- factor(tmp2)
...
colnames(mytable) <- c("I.IntactFemale","I.IntactMale","I.NeuteredMale","I.Null","I.SpayedFemale","I.Unknown")
mytable$x=c("I.Bird","I.Cat","I.Dog","I.Livestock","I.OtherType")
mytable <- mytable[c("x","I.IntactFemale","I.IntactMale","I.NeuteredMale","I.Null","I.SpayedFemale","I.Unknown")]
long_mytable <- mytable %>% gather(y, Count, I.IntactFemale:I.Unknown)
rm(mytable)

mytable <- table(joinDf$Sex.Intake,joinDf$Age.Intake)
mytable <- as.data.frame.matrix(mytable)
rownames(mytable) <- c("I.IntactFemale","I.IntactMale","I.NeuteredMale","I.Null","I.SpayedFemale","I.Unknown")
colnames(mytable) <- c("I.YoungerThan1YearOld","I.OlderThan6YearsOld","I.1to3YearsOld","I.3to6YearsOld")
mytable$x=c("I.IntactFemale","I.IntactMale","I.NeuteredMale","I.Null","I.SpayedFemale","I.Unknown")
...
mytable <- table(joinDf$Color.Intake,joinDf$Outcome)
mytable <- as.data.frame.matrix(mytable)
rownames(mytable) <- c("I.Black","I.BlacknWhite","I.Brown","I.BrownnTabby","I.BrownnWhite","I.OtherColor","I.TannWhite","I.White")
colnames(mytable) <- c("O.Other","O.Adoption","O.Died","O.Disposal","O.Euthanasia","O.Missing","O.Relocate","O.ReturnToOwner","O.Transfer")
mytable$x=c("I.Black","I.BlacknWhite","I.Brown","I.BrownnTabby","I.BrownnWhite","I.OtherColor","I.TannWhite","I.White")
mytable <- mytable[c("x","O.Other","O.Adoption","O.Died","O.Disposal","O.Euthanasia","O.Missing","O.Relocate","O.ReturnToOwner","O.Transfer")]
new_mytable <- mytable %>% gather(y, Count, O.Other : O.Transfer)
long_mytable <- rbind(long_mytable,new_mytable)
rm(mytable, new_mytable)

mytable <- table(joinDf$Outcome, joinDf$Type.Outcome)
mytable <- as.data.frame.matrix(mytable)
rownames(mytable) <- c("O.Other","O.Adoption","O.Died","O.Disposal","O.Euthanasia","O.Missing","O.Relocate","O.ReturnToOwner","O.Transfer")
colnames(mytable) <- c("O.Bird","O.Cat","O.Dog","O.Livestock","O.OtherType")
mytable$x=c("O.Other","O.Adoption","O.Died","O.Disposal","O.Euthanasia","O.Missing","O.Relocate","O.ReturnToOwner","O.Transfer")
...
mytable <- table(joinDf$Type.Outcome,joinDf$Age.Outcome)
mytable <- as.data.frame.matrix(mytable)
rownames(mytable) <- c("O.Bird","O.Cat","O.Dog","O.Livestock","O.OtherType")
colnames(mytable) <- c("O.YoungerThan1YearOld","O.OlderThan6YearsOld","O.1to3YearsOld","O.3to6YearsOld")
mytable$x=c("O.Bird","O.Cat","O.Dog","O.Livestock","O.OtherType")
...
colnames(mytable) <- c("O.IntactFemale","O.IntactMale","O.NeuteredMale","O.Null","O.SpayedFemale","O.Unknown")
mytable$x=c("O.YoungerThan1YearOld","O.OlderThan6YearsOld","O.1to3YearsOld","O.3to6YearsOld")
mytable <- mytable[c("x","O.IntactFemale","O.IntactMale","O.NeuteredMale","O.Null","O.SpayedFemale","O.Unknown")]
